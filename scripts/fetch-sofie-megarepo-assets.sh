...
# Immutable pin: tojemoc/sofie@729e11728170058673e69db1e98a8c045ee47e21 (smoke scripts restored + weather cities).
# Bump SHA + checksums together.
# Reject mutable overrides (main, tags, short SHAs). Only a full 40-char commit SHA is allowed.
PINNED_SOFIE_ASSETS_REF="729e11728170058673e69db1e98a8c045ee47e21"
