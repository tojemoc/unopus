...
# Immutable pin: tojemoc/sofie@559f16bbe9991575aef67807e7dadfd3b03bfb3c (SPRÁVY show polish).
# Bump SHA + checksums together.
# Reject mutable overrides (main, tags, short SHAs). Only a full 40-char commit SHA is allowed.
PINNED_SOFIE_ASSETS_REF="559f16bbe9991575aef67807e7dadfd3b03bfb3c"
