...
# Immutable pin: tojemoc/sofie@4355a27ecf6d91546fcba3edbfb22b834f5bc1d0 (SJV/SPORT CPS + volume).
# Bump SHA + checksums together.
# Reject mutable overrides (main, tags, short SHAs). Only a full 40-char commit SHA is allowed.
PINNED_SOFIE_ASSETS_REF="4355a27ecf6d91546fcba3edbfb22b834f5bc1d0"
