const LABELS: Record<string, string> = {
	...
	iluDurationMode: 'AUTO take after duration (site default)',
	durationMode: 'AUTO take after duration',
	showPartScriptExcerpt: 'Show script excerpt in story row (site default)',
	showPartScriptExcerptProfile: 'Show script excerpt in story row',
